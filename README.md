...
1) Реализация с использованием tesseract
2) Свёрточная нейронная сеть с помощью модели CRNN, которая представляет собой комбинацию сверточной нейронной сети backbone CNN и рекуррентной нейронной сети RNN. 
3) ---------
